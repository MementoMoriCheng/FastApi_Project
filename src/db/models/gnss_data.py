...
class FlightAlarm(Base):
    ...
    altitude = Column(Float, nullable=False, comment="高度")

    low_speed = Column(Boolean, comment="低速度")
    speed = Column(Float, nullable=False, comment="速度")
    ...
    # 预留
    note_1 = Column(Float, nullable=False, comment="预留")
    note_2 = Column(Float, nullable=False, comment="预留")
    note_3 = Column(Float, nullable=False, comment="预留")
